...
export function WhatsAppCTA() {
  return (
    <section id="join" className="py-24 relative overflow-hidden bg-gradient-to-br from-green-500/20 to-background border-y border-border">
      {/* Background Glow */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-6xl font-bold font-heading mb-6 max-w-3xl"
        >
          Join India&apos;s Most Active <br className="hidden md:block"/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">Student Tech Community</span>
        </motion.h2>
