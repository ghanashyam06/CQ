...
export function AboutSnapshot() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".about-solution", {
        opacity: 0, y: 30, scale: 0.95, duration: 0.6, delay: 0.3, ease: "power3.out",
  ...
  return (
    <section ref={sectionRef} id="about" className="py-12 sm:py-16 lg:py-24 relative overflow-hidden">
      <Threads color="rgba(0, 191, 99, 0.06)" count={6} speed={0.4} />

      {/* Subtle glow — capped so it never overflows on mobile */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[200px] sm:w-[350px] lg:w-[500px] h-[200px] sm:h-[350px] lg:h-[500px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="about-right">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-xl text-foreground mb-3">Built for ambitious builders.</p>
                  <p className="text-muted-foreground leading-relaxed">
                    CodeQuesters is a collaborative ecosystem where students, developers, and creators learn together, build real-world projects, explore opportunities, and grow through execution.
                  </p>
                  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {["Real-world collaboration", "Project-based learning", "Strong peer network", "Growth opportunities"].map((item, i) => (
                      <div key={i} className="flex items-center gap-2 rounded-lg border border-border/50 px-3 py-2 bg-background/30">
